...
class UserProfile(BaseModel):
    ...
    # region_code: Optional[str] = None  # 지역
    # marriage_status_code: Optional[str] = None  # 결혼여부
    # major_field_code: Optional[str] = None  # 전공
    # job_status_code: Optional[str] = None  # 취업 상태
    # special_biz_code: Optional[str] = None  # 특화분야